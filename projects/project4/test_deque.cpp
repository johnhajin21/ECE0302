...
TEST_CASE( "Linked List Insert Function Test/Get Entry Test", "[linkedlist]" ) {
...
TEST_CASE( "Linked List isEmpty function test/size of list test", "[linkedlist]" ) {
  LinkedList<int> Test;
  REQUIRE(Test.getLength() == 0);
...
TEST_CASE( "Linked List setEntry Function Test", "[linkedlist]" ) {
  LinkedList<int> Test;
  for(int i=1;i<100;i++)
  {
...
TEST_CASE( "Linked List Copy Constructor Test", "[linkedlist]" ) {
  LinkedList<int> Test;
  for(int i=1;i<100;i++)
  {
    REQUIRE(Test.insert(i,i));
...
TEST_CASE( "Linked List Operator Overloader Test", "[linkedlist]" ) {
  LinkedList<int> Test;
  for(int i=1;i<100;i++)
  {
    REQUIRE(Test.insert(i,i));
...
TEST_CASE( "Linked List Clear Function Test", "[linkedlist]" ) {
  LinkedList<int> Test;
...
TEST_CASE( "Linked List Swap Function Test", "[linkedlist]" ) {
  LinkedList<int> Test;
  for(int i=1;i<100;i++)
  {
    REQUIRE(Test.insert(i,i));
...
TEST_CASE( "Linked List Remove Function Test", "[linkedlist]" ) {
  LinkedList<int> Test;
