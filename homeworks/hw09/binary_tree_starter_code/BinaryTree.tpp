    ...
    NodeType* treePtr, FunctionType visit)
{
   if (treePtr != 0) {
        ...
        preorder(treePtr->leftChildPtr, visit);//Visit left sub-tree recursively
        preorder(treePtr->rightChildPtr, visit);//Visit right sub-tree recursively
    ...
    NodeType* treePtr, FunctionType visit)
{
    if (treePtr != 0) {
        ...
        inorder(treePtr->leftChildPtr, visit);//Visit left sub-tree recursively
        visit(treePtr->item);//Visit Root
        inorder(treePtr->rightChildPtr, visit);//Visit right sub-tree recursively
    }
};
    ...
    NodeType* treePtr, FunctionType visit)
{
    if (treePtr != 0) {
        // TODO
        postorder(treePtr->leftChildPtr, visit);//Visit left sub-tree recursively
        postorder(treePtr->rightChildPtr, visit);//Visit right sub-tree recursively
        visit(treePtr->item);//Visit Root
    }
};
